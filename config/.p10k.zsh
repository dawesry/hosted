# Generated by Powerlevel10k configuration wizard on 2022-08-17 at 23:10 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%m  my wife is horny for my penbus'
  ...
  # Custom prefix.
  # typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%244Fon '
